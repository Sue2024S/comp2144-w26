...
const createScene = async function() {
    ...
    function buildRandomShape() {
        ...
        switch(randomType) {
            ...
            case "box":
                mesh = BABYLON.MeshBuilder.CreateBox("box", { size: randomSize }, scene);
                break;

            case "sphere":
                mesh = BABYLON.MeshBuilder.CreateSphere("sphere", { diameter: randomSize }, scene);
                break;
